...
import { Settings, Package, ScanLine, Smartphone, Store, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue={defaultTab}>
        ...
        {isOwner && <TabsContent value="abandonados" className="mt-4"><LojinhaAbandonedPanel /></TabsContent>}
