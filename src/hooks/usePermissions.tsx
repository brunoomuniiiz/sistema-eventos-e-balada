...
export function usePermissions() {
  ...
  return {
    ...
    canSangria,
    canAoVivo,
    displayName: (useMask ? null : (data?.display_name ?? null)) as string | null,
    loading: isLoading,
  };
}
